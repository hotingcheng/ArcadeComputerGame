...
//	DWORD  dwLastShoot;
Enemy4_2::Enemy4_2( int time, int level ) {
...
int Enemy4_2::getStr() const {

	return iStr;

} // The end of Method getStr

const void Enemy4_2::setStr( const int iQtde ) {

	iStr = iQtde;

} // The end of Method setStr
	
const void Enemy4_2::lowStr( const int iQtde ) {

		iStr -= iQtde;

} // The end of Method lowStr

const void Enemy4_2::setQtdeDown( const int iNewQtde ) {

		iQtdeDown = iNewQtde;

} // The end of Method setQudeDown

BaseTreasure* Enemy4_2::createTreasure( const int iFlags)	
{	
...
int Enemy4_2::getTreasure() const {

		return iExtra;

} // The end of Method getTreasure

const void Enemy4_2::setAmDown( const int newAmDown) {

		amDown = newAmDown;

} // The end of Method setAmDown

int Enemy4_2::getAmDown() const {
...
const void Enemy4_2::setStrength( const int newStrength ) {
...
int Enemy4_2::getStrength() const {
...
const void Enemy4_2::setSpeed( const int newSpeed ) {

	speed = newSpeed;

} // The end of Method setSpeed

int Enemy4_2::getSpeed() const {

	return speed;

} // The end of Method getSpeed

const void Enemy4_2::setXY( const int newx, const int newy) {

	xPos = newx;
	yPos = newy;

} // The end of Method Enemy4_2

int Enemy4_2::getXPos() const {

		return xPos;

} // The end of Method getX

int Enemy4_2::getYPos() const {

		return yPos;

} // The end of Method getYPos

int Enemy4_2::getWidth() const {

		return width;

} // The end of Method getWidth

int Enemy4_2::getHeight() const {

		return height;

} // The end of Method getHeight

BaseEnemy* Enemy4_2::getNext() const {

		return next;

} // The end of Method getNext

const void Enemy4_2::setNext( BaseEnemy* nxEnemy) {

		next = nxEnemy;

} // The end of Method setNext

const void Enemy4_2::setState( const int iNewState) {
...
int Enemy4_2::move(int iFlags) {


		return TRUE;
	}

bool Enemy4_2::isExploding() const {
...
bool Enemy4_2::isDropExtra() const {
...
bool Enemy4_2::isDestroyMe() const {
...
HRESULT Enemy4_2::draw( LPDIRECTDRAWSURFACE7 lpDest ) {
...
const void Enemy4_2::checkBoundary() {
...
const void Enemy4_2::updateFrame() {
/*
	frame++;
	if ( frame > 1 )
		frame = 1;
...
const void Enemy4_2::updateExplosionFrame() { 
...
int Enemy4_2::getState() const
{
	return state;
}

int Enemy4_2::getTimeAppear()
{
	return timeAppear;
}

Strategy *Enemy4_2::getStrategy()
{
	return S;
}

bool Enemy4_2::CheckHit(vector<BaseBullet*> playerbulletList)
{
	bool hit=false;
	int count=0;
...
void Enemy4_2::setappear()
{
	appear = true;
}

bool Enemy4_2::getappear()
{
	return appear; 
}
