#include "Treasure4.h"
/*
Treasure4::Treasure4(Treasure4& T)
{
	Destroy = 0;
	xPos = 0;
	yPos = 0;
...
Treasure4::Treasure4() {
	...
	lpDDNormal = Graphics()->DDLoadBitmap ( Graphics()->getDirectDraw(), 
								   MAKEINTRESOURCE(IDB_treasure4), 
								   0, 0 );

	if ( lpDDNormal == NULL )
		throw GameError("Error in DDLoadBitmap of Treasure4");
...
int Treasure4::getType() const {

	return iType;

} // The end of Method getType

const void Treasure4::setType(int iNewType) {

	iType = iNewType;

} // The end of Method setType

int Treasure4::getXPos() const {

	return xPos;

} // The end of Method getX

int Treasure4::getYPos() const {

	return yPos;

} // The end of Method getYPos

const void Treasure4::move(int Qtde) {
...
const void Treasure4::setXY(const int nx, const int ny) {
...
bool Treasure4::draw(LPDIRECTDRAWSURFACE7 lpDest )  {
...
void Treasure4::setDestroy()
{
	Destroy = 1;
}

int Treasure4::getDestroy()
{
	return Destroy;
}
const void Treasure4::checkBoundary() {
