...
EnemyBullet3::EnemyBullet3() {
	...
	lpDDNormal = Graphics()->DDLoadBitmap ( Graphics()->getDirectDraw(), 
								   MAKEINTRESOURCE(IDB_EnemyBullet3), 
								   0, 0 );
...
int EnemyBullet3::getType() const {

	return iType;

} // The end of Method getType

const void EnemyBullet3::setType( const int iNewType) {

	iType = iNewType;

} // The end of Method setType

int EnemyBullet3::getXPos() const {

	return xPos;

} // The end of Method getXPos

int EnemyBullet3::getYPos() const {

	return yPos;

} // The end of getYPos

int EnemyBullet3::getWidth() const {

	return width;

} // The end of getWidth

int EnemyBullet3::getHeight() const {

	return height;

} // The end of getHeight

const void EnemyBullet3::setPower( int newp ) {

	power = newp;

} // The end of Method setPower

int EnemyBullet3::getPower() const {

	return power;

} // The end of Method getPower
	
const void EnemyBullet3::move(int movex, int movey) {

	xPos -= speed;

} // The end of Method move

const void EnemyBullet3::setXY(int newx, int newy) {
...
const void EnemyBullet3::setDestroy( const int destroy ) {

	isDestroy = destroy;

} // The end of Method setDestroy

int EnemyBullet3::getDestroy() const {

	return isDestroy;

} // The end of Method getDestroy

bool EnemyBullet3::draw( LPDIRECTDRAWSURFACE7 lpDest, int ppx, int ppy ) {
...
const void EnemyBullet3::checkDestroy() {
...
void EnemyBullet3::trackplayerposition()
{
}
