...
cSound::cSound( char* filename )
{
    ...
    {
        throw GameError("couldn't open file!");
    }
...
void cSound::Init()
{
    ...
    if( FAILED( hr ) )
    {
        throw GameError("CreateSoundBuffer failed!");
    }
	...
	if( FAILED( hr ) )
    {
        throw GameError("SoundBuffer query to 8 failed!");
    }
...
void cSound::Restore()
{
	...
	{
		throw GameError( "couldn't get buffer status" );
	}
...
void cSound::Fill()
{
	...
	{
	    delete [] pbWavData;
        throw GameError("m_pWaveSoundRead->Read failed");
	}
	...
	{
	    delete [] pbWavData;
        throw GameError("m_pBuffer->Lock failed");
	}
...
void cSound::Play( bool bLoop )
{
	...
	{
		throw GameError("m_pBuffer->Play failed");
	}
}
