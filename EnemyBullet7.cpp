...
EnemyBullet7::EnemyBullet7() {
	...
	lpDDNormal = Graphics()->DDLoadBitmap ( Graphics()->getDirectDraw(), 
								   MAKEINTRESOURCE(IDB_EnemyBullet7), 
								   0, 0 );
...
int EnemyBullet7::getType() const {

	return iType;

} // The end of Method getType

const void EnemyBullet7::setType( const int iNewType) {

	iType = iNewType;

} // The end of Method setType

int EnemyBullet7::getXPos() const {

	return xPos;

} // The end of Method getXPos

int EnemyBullet7::getYPos() const {

	return yPos;

} // The end of getYPos

int EnemyBullet7::getWidth() const {

	return width;

} // The end of getWidth

int EnemyBullet7::getHeight() const {

	return height;

} // The end of getHeight

const void EnemyBullet7::setPower( int newp ) {

	power = newp;

} // The end of Method setPower

int EnemyBullet7::getPower() const {

	return power;

} // The end of Method getPower
	
const void EnemyBullet7::move(int movex, int movey) {

	xPos -= speed;

} // The end of Method move

const void EnemyBullet7::setXY(int newx, int newy) {
...
const void EnemyBullet7::setDestroy( const int destroy ) {

	isDestroy = destroy;

} // The end of Method setDestroy

int EnemyBullet7::getDestroy() const {

	return isDestroy;

} // The end of Method getDestroy

bool EnemyBullet7::draw( LPDIRECTDRAWSURFACE7 lpDest, int ppx, int ppy ) {
...
const void EnemyBullet7::checkDestroy() {
...
void EnemyBullet7::trackplayerposition()
{
}
