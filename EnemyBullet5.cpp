...
EnemyBullet5::EnemyBullet5() {
	...
	lpDDNormal = Graphics()->DDLoadBitmap ( Graphics()->getDirectDraw(), 
								   MAKEINTRESOURCE(IDB_EnemyBullet5), 
								   0, 0 );
...
int EnemyBullet5::getType() const {

	return iType;

} // The end of Method getType

const void EnemyBullet5::setType( const int iNewType) {

	iType = iNewType;

} // The end of Method setType

int EnemyBullet5::getXPos() const {

	return xPos;

} // The end of Method getXPos

int EnemyBullet5::getYPos() const {

	return yPos;

} // The end of getYPos

int EnemyBullet5::getWidth() const {

	return width;

} // The end of getWidth

int EnemyBullet5::getHeight() const {

	return height;

} // The end of getHeight

const void EnemyBullet5::setPower( int newp ) {

	power = newp;

} // The end of Method setPower

int EnemyBullet5::getPower() const {

	return power;

} // The end of Method getPower
	
const void EnemyBullet5::move(int movex, int movey) {

	xPos -= speed;

} // The end of Method move

const void EnemyBullet5::setXY(int newx, int newy) {
...
const void EnemyBullet5::setDestroy( const int destroy ) {

	isDestroy = destroy;

} // The end of Method setDestroy

int EnemyBullet5::getDestroy() const {

	return isDestroy;

} // The end of Method getDestroy

bool EnemyBullet5::draw( LPDIRECTDRAWSURFACE7 lpDest, int ppx, int ppy ) {
...
const void EnemyBullet5::checkDestroy() {
...
void EnemyBullet5::trackplayerposition()
{
}
